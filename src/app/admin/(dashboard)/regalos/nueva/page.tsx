...
export default function NewRewardTierPage({ searchParams }: { searchParams: { error?: string } }) {
  return (
    <div>
      <h1 className="mb-6 text-2xl font-bold text-gray-900">Nuevo regalo</h1>
      <RewardTierForm action={createRewardTier} submitLabel="Crear regalo" errorMessage={searchParams.error} />
    </div>
  );
}
